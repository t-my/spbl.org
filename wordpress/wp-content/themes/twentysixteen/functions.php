...
function julkaisut() {
     ...
     register_post_type( 'julkaisut', $args );
 }
 add_action( 'init', 'julkaisut' );
...
function tiedotteet() {
     ...
     register_post_type( 'tiedotteet', $args );
 }
 add_action( 'init', 'tiedotteet' );
